 ...
 * @author Hector
 */
public class CostoFabricacionEditView extends javax.swing.JDialog {

    /**
     * 1- Usar Vo correcto
     */
    private CostoFabricacionVo costofabricacion;
    private boolean ok;
     ...
     */
    public CostoFabricacionEditView(java.awt.Frame parent, boolean modal, CostoFabricacionVo costofabricacion) {
        super(parent, modal);
        initComponents();
        ...
        //init values
        txDescripcion.setText(String.valueOf(costofabricacion.getDescripcion()));
        txMonto.setText(String.valueOf(costofabricacion.getMonto()));
        ...
        bAceptar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                getCostoFabricacion().setDescripcion(txDescripcion.getText());
                getCostoFabricacion().setMonto(Float.valueOf(txMonto.getText()));
                
                setOk(true);
                CostoFabricacionEditView.this.setVisible(false);
            }
        });
     ...
     * @return the language
     */
    public CostoFabricacionVo getCostoFabricacion() {
     ...
     */
    public void setCostoFabricacion(CostoFabricacionVo empleado) {
        this.costofabricacion = costofabricacion;
    }
