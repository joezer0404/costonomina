 ...
 * @author Hector
 */
public class CostoFijoFrameView extends javax.swing.JFrame {

    /**
     * 1- Usar TableModel adecuado
     */
    CostoFijoTableModel tableModel;
    
    /**
     * Creates new form PersonalView
     * @param connection
     */
    public CostoFijoFrameView(IDbConnection connection) {
        initComponents();
        // 2.1 - Usar Table model adecuado
        tableModel = new CostoFijoTableModel(connection);
        ...
        bBuscar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                CostoFijoDao CostoFijoDao = new CostoFijoDao();
                ...
                // 2.4 - AdaptarVo
                List<CostoFijoVo> costofijo = CostoFijoDao.getList(connection, options);
                tableModel.setCostoFijo(costofijo);
            }
        });
        ...
        bAgregar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                CostoFijoEditView editView = new CostoFijoEditView(CostoFijoFrameView.this, true, new CostoFijoVo());
                editView.setVisible(true);
                if (editView.isOk()){
                    CostoFijoVo l = editView.getCostoFijo();
                    CostoFijoDao CostoFijoDao = new CostoFijoDao();
                    boolean flag = CostoFijoDao.insertRecord(connection, l, null);
                    if (flag){
                        tableModel.addRow(l);
                    }
                }
        ...
        bModificar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                CostoFijoVo l = tableModel.getCostoFijo(tbBuscar.getSelectedRow());
                if (l == null){
                    JOptionPane.showMessageDialog(CostoFijoFrameView.this, "No se eligio ninguna descripcion.", "Eliminar Item", JOptionPane.INFORMATION_MESSAGE);
                    return;
                }

                CostoFijoEditView editView = new CostoFijoEditView(CostoFijoFrameView.this, true, l);
                editView.setVisible(true);
                if (editView.isOk()){
                    l = editView.getCostoFijo();
                    CostoFijoDao CostoFijoDao = new CostoFijoDao();
                    boolean flag = CostoFijoDao.updateRecord(connection, l, null);
                    if (flag){
        ...
        bEliminar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                CostoFijoVo l = tableModel.getCostoFijo(tbBuscar.getSelectedRow());
                if (l == null){
                    JOptionPane.showMessageDialog(CostoFijoFrameView.this, "No item elegido.", "Eliminar item", JOptionPane.INFORMATION_MESSAGE);
                    return;
                }

                CostoFijoDao CostoFijoDao = new CostoFijoDao();
                boolean flag = CostoFijoDao.deleteRecord(connection, l, null);
                if (flag){
