 ...
 * @author Hector
 */
public class GastosAdministracionFrameView extends javax.swing.JFrame {

    /**
     * 1- Usar TableModel adecuado
     */
    GastosAdministracionTableModel tableModel;
    
    /**
     * Creates new form PersonalView
     * @param connection
     */
    public GastosAdministracionFrameView(IDbConnection connection) {
        initComponents();
        // 2.1 - Usar Table model adecuado
        tableModel = new GastosAdministracionTableModel(connection);
        ...
        bBuscar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                GastosAdministracionDao GastosAdministracionDao = new GastosAdministracionDao();
                ...
                // 2.4 - AdaptarVo
                List<GastosAdministracionVo> gastosadministracion = GastosAdministracionDao.getList(connection, options);
                tableModel.setGastosAdministracion(gastosadministracion);
            }
        });
        ...
        bAgregar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                GastosAdministracionEditView editView = new GastosAdministracionEditView(GastosAdministracionFrameView.this, true, new GastosAdministracionVo());
                editView.setVisible(true);
                if (editView.isOk()){
                    GastosAdministracionVo l = editView.getGastosAdministracion();
                    GastosAdministracionDao GastosAdministracionDao = new GastosAdministracionDao();
                    boolean flag = GastosAdministracionDao.insertRecord(connection, l, null);
                    if (flag){
                        tableModel.addRow(l);
                    }
                }
        ...
        bModificar.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) { //revisar
                // 2.6 Adaptar Vo, mensaje en caso de error, EditView y Dao
                GastosAdministracionVo l = tableModel.getGastosAdministracion(tbBuscar.getSelectedRow());
                if (l == null){
                    JOptionPane.showMessageDialog(GastosAdministracionFrameView.this, "No se eligio ninguna descripcion.", "Eliminar Item", JOptionPane.INFORMATION_MESSAGE);
                    return;
                }

                GastosAdministracionEditView editView = new GastosAdministracionEditView(GastosAdministracionFrameView.this, true, l);
                editView.setVisible(true);
                if (editView.isOk()){
                    l = editView.getGastosAdministracion();
                    GastosAdministracionDao GastosVentasDao = new GastosAdministracionDao();
                    boolean flag = GastosVentasDao.updateRecord(connection, l, null);
                    if (flag){
        ...
        bEliminar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                GastosAdministracionVo l = tableModel.getGastosAdministracion(tbBuscar.getSelectedRow());
                if (l == null){
                    JOptionPane.showMessageDialog(GastosAdministracionFrameView.this, "No item elegido.", "Eliminar item", JOptionPane.INFORMATION_MESSAGE);
                    return;
                }

                GastosAdministracionDao GastosVentaDao = new GastosAdministracionDao();
                boolean flag = GastosVentaDao.deleteRecord(connection, l, null);
                if (flag){
    ...
    private void initComponents() {
        ...
        setTitle("Gastos administracion");
