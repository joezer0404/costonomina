 ...
 * @author Hector
 */
public class NominaFrameView extends javax.swing.JFrame {

    
    /**
     * 1- Usar TableModel adecuado
     */
    NominaTableModel tableModel;
    
    /**
     * Creates new form PersonalView
     * @param connection
     */
    public NominaFrameView(IDbConnection connection) {
        initComponents();
        // 2.1 - Usar Table model adecuado
        tableModel = new NominaTableModel(connection);
        ...
        bBuscar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                // 2.4 - AdaptarVo
                List<NominaVo> nominas = nominaDao.getList(connection, options);
                tableModel.setNominas(nominas);
        ...
        bAgregar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                NominaEditView editView = new NominaEditView(NominaFrameView.this, true, new NominaVo(), connection);
                editView.setVisible(true);
                if (editView.isOk()){
                    NominaVo l = editView.getNomina();
                    NominaDao nominaDao = new NominaDao();
                    boolean flag = nominaDao.insertRecord(connection, l, null);
                    if (flag){
                        tableModel.addRow(l);
                    }
                }
        ...
        bModificar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                NominaVo l = tableModel.getNominas(tbBuscar.getSelectedRow());
                if (l == null){
                    JOptionPane.showMessageDialog(NominaFrameView.this, "No se eligio ninguna nomina.", "Eliminar nomina", JOptionPane.INFORMATION_MESSAGE);
                    return;
                }

                NominaEditView editView = new NominaEditView(NominaFrameView.this, true, l, connection);
                editView.setVisible(true);
                if (editView.isOk()){
                    l = editView.getNomina();
                    NominaDao nominaDao = new NominaDao();
                    boolean flag = nominaDao.updateRecord(connection, l, null);
                    if (flag){
        ...
        bEliminar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                NominaDao nominaDao = new NominaDao();
                boolean flag = nominaDao.deleteRecord(connection, l, null);
                if (flag){
    ...
    private void initComponents() {
        ...
        cbBuscar.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Fecha" }));
        ...
        pBuscarLayout.setHorizontalGroup(
            ...
            .addGroup(pBuscarLayout.createSequentialGroup()
                ...
                .addComponent(txBuscar, javax.swing.GroupLayout.DEFAULT_SIZE, 230, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(cbBuscar, javax.swing.GroupLayout.PREFERRED_SIZE, 194, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                .addComponent(bBuscar, javax.swing.GroupLayout.DEFAULT_SIZE, 87, Short.MAX_VALUE)
        ...
        pBotonesLayout.setVerticalGroup(
            ...
            .addGroup(pBotonesLayout.createSequentialGroup()
                .addGap(0, 0, 0)
                .addComponent(bAgregar, javax.swing.GroupLayout.DEFAULT_SIZE, 65, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(bModificar, javax.swing.GroupLayout.DEFAULT_SIZE, 65, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(bEliminar, javax.swing.GroupLayout.DEFAULT_SIZE, 64, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(bSalir, javax.swing.GroupLayout.DEFAULT_SIZE, 65, Short.MAX_VALUE)
                .addGap(0, 0, 0))
        );
        ...
        pTableLayout.setHorizontalGroup(
            ...
            .addGroup(pTableLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(spBuscar, javax.swing.GroupLayout.DEFAULT_SIZE, 521, Short.MAX_VALUE)
                .addGap(0, 0, 0)
