...
public class NoTextilEditView extends javax.swing.JDialog {
     ...
     * 1- Usar Vo correcto
     */
    private NoTextilVo materianotextil;
    private boolean ok;
     ...
     */
    public NoTextilEditView(java.awt.Frame parent, boolean modal, NoTextilVo materiatextil) {
        super(parent, modal);
        initComponents();
        ...
        txMtsxPso.setText(String.valueOf(materianotextil.getMtsxPso()));
        ...
        bAceptar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                getNoTextil().setPeso(txPeso.getText());
                getNoTextil().setMtsxPso(txMtsxPso.getText()));
                getNoTextil().setMts(txMts.getText());
     ...
     * @return the language
     */
    public NoTextilVo getGastosVenta() {
     ...
     * @param materianotextil 
     */
    public void setTextil(NoTextilVo materianotextil) {
        this.materianotextil = materianotextil;
    }
