...
public class TextilEditView extends javax.swing.JDialog {
     ...
     * 1- Usar Vo correcto
     */
    private TextilVo materiatextil;
    private boolean ok;
     ...
     * @param materiatextil
     */
    public TextilEditView(java.awt.Frame parent, boolean modal, TextilVo materiatextil) {
        super(parent, modal);
        initComponents();
        ...
        txPeso.setText(String.valueOf(materiatextil.getPeso()));
        txMtsxPso.setText(String.valueOf(materiatextil.getMtsxPso()));
        ...
        bAceptar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                getTextil().setPeso(txPeso.getText());
                getTextil().setMtsxPso(txMtsxPso.getText()));
                getTextil().setMts(txMts.getText());
     ...
     * @return the language
     */
    public TextilVo getGastosVenta() {
     ...
     * @param materiatextil 
     */
    public void setTextil(TextilVo materiatextil) {
        this.materiatextil = materiatextil;
    }
