...
public class NoTextilTableModel extends AbstractTableModel {
     ...
     */
    private NoTextilDao     NoTextilDao;
    /**
     * 4- La lista de objetos a mostrar en la tabla, usar Vo adecuado
     */
    private List<NoTextilVo>  materianotextil;
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        ...
        NoTextilVo textil = materianotextil.get(rowIndex);
     ...
     * @return 
     */
    public NoTextilVo getNoTextil(int index){
     ...
     * @param l 
     */
    public void addRow(NoTextilVo l){
     ...
     * @param l 
     */
    public void updateRow(int index, NoTextilVo l){
     ...
     * @param materiatextil 
     */
    public void setGastosVenta(List<NoTextilVo> materiatextil){
