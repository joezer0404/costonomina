...
import app.modelo.dao.NoTextilDao;
 ...
 * @author Hector
 */
public class NoTextilFrameView extends javax.swing.JFrame {

    /**
     * 1- Usar TableModel adecuado
     */
    NoTextilTableModel tableModel;
    
    /**
     * Creates new form PersonalView
     * @param connection
     */
    public NoTextilFrameView(IDbConnection connection) {
        initComponents();
        // 2.1 - Usar Table model adecuado
        tableModel = new NoTextilTableModel(connection);
        ...
        bBuscar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                NoTextilDao TextilDao = new NoTextilDao();
                ...
                // 2.4 - AdaptarVo
                List<NoTextilVo> materianotextil = NoTextilDao.getList(connection, options);
                tableModel.setTextil(materianotextil);
            }
        });
        ...
        bAgregar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                NoTextilEditView editView = new NoTextilEditView(NoTextilFrameView.this, true, new NoTextilVo());
                editView.setVisible(true);
                if (editView.isOk()){
                    NoTextilVo l = editView.getNoTextil();
                    NoTextilDao NoTextilDao = new NoTextilDao();
                    boolean flag = NoTextilDao.insertRecord(connection, l, null);
                    if (flag){
                        tableModel.addRow(l);
                    }
                }
        ...
        bModificar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                NoTextilVo l = tableModel.getNoTextil(tbBuscar.getSelectedRow());
                if (l == null){
                    JOptionPane.showMessageDialog(NoTextilFrameView.this, "No se eligio ninguna descripcion.", "Eliminar Item", JOptionPane.INFORMATION_MESSAGE);
                    return;
                }
                ...
                if (editView.isOk()){
                    ...
                    NoTextilDao NoTextilDao = new NoTextilDao();
                    boolean flag = NoTextilDao.updateRecord(connection, l, null);
                    if (flag){
        ...
        bEliminar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                NoTextilVo l = tableModel.getNoTextil(tbBuscar.getSelectedRow());
                if (l == null){
                    JOptionPane.showMessageDialog(NoTextilFrameView.this, "No item elegido.", "Eliminar item", JOptionPane.INFORMATION_MESSAGE);
                    return;
                }

                NoTextilDao NoTextilDao = new NoTextilDao();
                boolean flag = NoTextilDao.deleteRecord(connection, l, null);
                if (flag){
