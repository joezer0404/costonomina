...
import app.vista.costofabricacion.*;
 ...
 * @author Hector
 */
public class CostoFabricacionFrameView extends javax.swing.JFrame {

    /**
     * 1- Usar TableModel adecuado
     */
    CostoFabricacionTableModel tableModel;
    
    /**
     * Creates new form PersonalView
     * @param connection
     */
    public CostoFabricacionFrameView(IDbConnection connection) {
        initComponents();
        // 2.1 - Usar Table model adecuado
        tableModel = new CostoFabricacionTableModel(connection);
        ...
        bBuscar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                CostoFabricacionDao CostoFabricacionDao = new CostoFabricacionDao();
                ...
                // 2.4 - AdaptarVo
                List<CostoFabricacionVo> costofabricacion = CostoFabricacionDao.getList(connection, options);
                tableModel.setCostoFabricacion(costofabricacion);
            }
        });
        ...
        bAgregar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                CostoFabricacionEditView editView = new CostoFabricacionEditView(CostoFabricacionFrameView.this, true, new CostoFabricacionVo());
                editView.setVisible(true);
                if (editView.isOk()){
                    CostoFabricacionVo l = editView.getCostoFabricacion();
                    CostoFabricacionDao CostoFabricacionDao = new CostoFabricacionDao();
                    boolean flag = CostoFabricacionDao.insertRecord(connection, l, null);
                    if (flag){
                        tableModel.addRow(l);
                    }
                }
        ...
        bModificar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                CostoFabricacionVo l = tableModel.getCostoFabricacion(tbBuscar.getSelectedRow());
                if (l == null){
                    JOptionPane.showMessageDialog(CostoFabricacionFrameView.this, "No se eligio ningun empleado.", "Eliminar personal", JOptionPane.INFORMATION_MESSAGE);
                    return;
                }

                CostoFabricacionEditView editView = new CostoFabricacionEditView(CostoFabricacionFrameView.this, true, l);
                editView.setVisible(true);
                if (editView.isOk()){
                    l = editView.getCostoFabricacion();
                    CostoFabricacionDao CostoFabricacionDao = new CostoFabricacionDao();
                    boolean flag = CostoFabricacionDao.updateRecord(connection, l, null);
                    if (flag){
        ...
        bEliminar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                CostoFabricacionVo l = tableModel.getCostoFabricacion(tbBuscar.getSelectedRow());
                if (l == null){
                    JOptionPane.showMessageDialog(CostoFabricacionFrameView.this, "No personal elegido.", "Eliminar personal", JOptionPane.INFORMATION_MESSAGE);
                    return;
                }

                CostoFabricacionDao CostoFabricacionDao = new CostoFabricacionDao();
                boolean flag = CostoFabricacionDao.deleteRecord(connection, l, null);
                if (flag){
