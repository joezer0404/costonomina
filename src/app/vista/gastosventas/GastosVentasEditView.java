 ...
 * @author Hector
 */
public class GastosVentasEditView extends javax.swing.JDialog {

    /**
     * 1- Usar Vo correcto
     */
    private GastosVentaVo gastosventa;
    private boolean ok;
     ...
     * @param gastosventa
     */
    public GastosVentasEditView(java.awt.Frame parent, boolean modal, GastosVentaVo gastosventa) {
        super(parent, modal);
        initComponents();
        ...
        //init values
        txDescripcion.setText(String.valueOf(gastosventa.getDescripcion()));
        txMonto.setText(String.valueOf(gastosventa.getMonto()));
        ...
        bAceptar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                getGastosVenta().setDescripcion(txDescripcion.getText());
                getGastosVenta().setMonto(Float.valueOf(txMonto.getText()));
                
                setOk(true);
                GastosVentasEditView.this.setVisible(false);
            }
        });
     ...
     * @return the language
     */
    public GastosVentaVo getGastosVenta() {
        return gastosventa;
    }
     ...
     * @param gastosventa 
     */
    public void setGastosVenta(GastosVentaVo gastosventa) {
        this.gastosventa = gastosventa;
    }
