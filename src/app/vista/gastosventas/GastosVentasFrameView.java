 ...
 * @author Hector
 */
public class GastosVentasFrameView extends javax.swing.JFrame {

    /**
     * 1- Usar TableModel adecuado
     */
    GastosVentasTableModel tableModel;
    
    /**
     * Creates new form PersonalView
     * @param connection
     */
    public GastosVentasFrameView(IDbConnection connection) {
        initComponents();
        // 2.1 - Usar Table model adecuado
        tableModel = new GastosVentasTableModel(connection);
        ...
        bBuscar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                GastosVentaDao GastosVentaDao = new GastosVentaDao();
                ...
                // 2.4 - AdaptarVo
                List<GastosVentaVo> gastosventa = GastosVentaDao.getList(connection, options);
                tableModel.setGastosVenta(gastosventa);
            }
        });
        ...
        bAgregar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                GastosVentasEditView editView = new GastosVentasEditView(GastosVentasFrameView.this, true, new GastosVentaVo());
                editView.setVisible(true);
                if (editView.isOk()){
                    GastosVentaVo l = editView.getGastosVenta();
                    GastosVentaDao GastosVentaDao = new GastosVentaDao();
                    boolean flag = GastosVentaDao.insertRecord(connection, l, null);
                    if (flag){
                        tableModel.addRow(l);
                    }
                }
        ...
        bModificar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                GastosVentaVo l = tableModel.getGastosVenta(tbBuscar.getSelectedRow());
                if (l == null){
                    JOptionPane.showMessageDialog(GastosVentasFrameView.this, "No se eligio ninguna descripcion.", "Eliminar Item", JOptionPane.INFORMATION_MESSAGE);
                    return;
                }

                GastosVentasEditView editView = new GastosVentasEditView(GastosVentasFrameView.this, true, l);
                editView.setVisible(true);
                if (editView.isOk()){
                    l = editView.getGastosVenta();
                    GastosVentaDao GastosVentasDao = new GastosVentaDao();
        ...
        bEliminar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                GastosVentaVo l = tableModel.getGastosVenta(tbBuscar.getSelectedRow());
                if (l == null){
                    JOptionPane.showMessageDialog(GastosVentasFrameView.this, "No item elegido.", "Eliminar item", JOptionPane.INFORMATION_MESSAGE);
                    return;
                }
