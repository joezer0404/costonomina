    ...
    public NoTextilFrameView(IDbConnection connection) {
        ...
        bBuscar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                MateriaPrimaNoTextilDao noTextilDao = new MateriaPrimaNoTextilDao();
                ...
                // 2.4 - AdaptarVo
                List<MateriaPrimaNoTextilVo> materianotextil = noTextilDao.getList(connection, options);
        ...
        bModificar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                MateriaPrimaNoTextilVo l = tableModel.getNoTextil(tbBuscar.getSelectedRow());
                if (l == null){
