    ...
    public TextilFrameView(IDbConnection connection) {
        ...
        bBuscar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                TextilDao TextilDao = new TextilDao();
                ...
                // 2.4 - AdaptarVo
                List<TextilVo> materiatextil = TextilDao.getList(connection, options);
        ...
        bAgregar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                TextilEditView editView = new TextilEditView(TextilFrameView.this, true, new TextilVo());
                editView.setVisible(true);
                if (editView.isOk()){
                    TextilVo l = editView.getTextil();
                    TextilDao TextilDao = new TextilDao();
        ...
        bModificar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                TextilVo l = tableModel.getTextil(tbBuscar.getSelectedRow());
                if (l == null){
